...
export const AdjacencyMatrixTable = ({
  ...
  return (
    <div className=" w-fit mx-auto relative pr-10 pb-10">
                ...
                <td
                  ...
                  className={cn(
                    ...
                    cell === 1
                      ...
                      isDisabled && " cursor-not-allowed bg-gray-50/30 hover:bg-gray-50/30 dark:bg-gray-800/30 dark:hover:bg-gray-800/30 text-gray-400 dark:text-gray-600 "
                  )}
                >
                  {cell}
                </td>
      ...
      {!disableAdd && (
        <div className="w-full flex justify-end bg-slate-200 dark:bg-slate-700">
          <Button
            variant="destructive"
            className="m-2 bg-green-500 hover:bg-green-600 dark:bg-green-600 dark:hover:bg-green-700"
            onClick={onAdd}
          >
            Add <Plus />
          </Button>
