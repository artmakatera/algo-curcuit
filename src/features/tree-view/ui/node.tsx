    ...
    >
      <motion.div
        className={cn(
          ...
          isSwapNode && !isSwapPlaceholder && "bg-violet-600 border-violet-400",
          isSwapPlaceholder && "bg-background transition-none",
          isHidden && "invisible",
          isPlaceholder && "bg-background border-border transition-none",
        )}
        ref={ref}
      ...
      >
        {isPlaceholder ? null : current?.value}
      </motion.div>
    </motion.div>
  );
};
